...
<form method="POST" action="proses_product.php">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        value="<?php if(isset($row['sell_price'])) echo $row['sell_price']; ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">product type</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">restock id</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
