...
<head>
  ...
  <!-- 
    - primary meta tag
  -->
  <title>Kittern - Hight Quality Pet Food</title>
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="index.html" class="navbar-link" data-nav-link>Shop</a>
          </li>
          ...
          <li>
            <a href="login.html" class="btn btn-light rounded-0 me-2" data-nav-link>Log In</a>
          </li>

          <li>
            <a href="login.html" class="btn btn-outline-light rounded-0" data-nav-link>Sign up</a>
          </li>
      ...
      <section class="section category" aria-label="category">
        <div class="offer-card has-bg-image img-holder">
          ...
          <ul class="has-scrollbar">
            ...
            <li class="scrollbar-item">
              <div class="category-card">
                ...
                <figure class="card-banner img-holder" style="--width: 330; --height: 300;">
                  <img src="./assets/images/Product-2.3.jpg" width="330" height="300" loading="lazy" alt="Cat Food"
                    class="img-cover">
                </figure><br><br>

                <h3 class="h3">
                  <div class="fs-5 mb-4">
                    <span class="fs-1 fw-bold">Rp220.000</span><br>
                    <p class="fs-6 fw-light mb-1">Stok tersedia: 8</p>
                  </div>
            ...
            <td>
              <tr>Makanan kucing Whiskas® kami memiliki rasa yang luar biasa dan mengandung semua nutrien, vitamin, dan
                mineral yang dibutuhkan kucing Anda. Dari kibble yang renyah hingga makanan basah yang menggiurkan,
                Whiskas® memiliki berbagai macam makanan basah dan kering yang lezat untuk dipilih, menjadikannya satu
                dari beberapa merek makanan kucing terbaik yang ada. Makanan kucing Whiskas® dibuat oleh ahli gizi dan
                dokter hewan dari Institut Ilmu Perawatan Hewan Peliharaan (Petcare Science Institute) Waltham untuk
                memenuhi kebutuhan nutrisi dan kesehatan kucing Anda. Tidak perduli apakah Anda memiliki anak kucing,
                kucing dewasa, maupun kucing senior, makanan kucing Whiskas® memenuhi semua kebutuhan mereka.</tr>
            </td>
            <br><br>
            <td>
              <tr>Aditif (per kg): Aditif nutrisi: Vitamin A: 22500 IU, Vitamin D3: 1000 IU, Vitamin E: 700 mg, E1
                (Besi): 40 mg, E2 (Yodium): 4 mg, E4 (Tembaga): 12 mg , E5 (Mangan): 52 mg, E6 (Seng): 130 mg, E8
                (Selenium): 0,07 mg - Aditif teknologi: Klinoptilolit asal sedimen: 10 g - Pengawet - Antioksidan.</tr>
            </td>
            <br><br>
  ...
  <footer class="footer" style="background-image: url('./assets/images/footer-bg.jpg')">
        ...
        <div class="footer-brand">
          ...
          <ul class="contact-list">
            ...
            <li class="contact-item">
              ...
              <a href="tel:+16234567891011" class="contact-link">(+62)123-456-789</a>
            </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2023 Made with ♥ by <a href="#" class="copyright-link">BOOSTRAP.</a>
        </p>
