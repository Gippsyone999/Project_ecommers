      ...
      <section class="section category" aria-label="category">
        <div class="offer-card">
          ...
          <h2 class="h2 section-title">
            <span class="span">Royal</span> Canin
          </h2>
          ...
          <ul class="has-scrollbar">
            ...
            <li class="scrollbar-item">
              <div class="category-card">
                ...
                <figure class="card-banner img-holder" style="--width: 330; --height: 700;">
                  <img src="./assets/images/product-1.jpg" width="330" height="300" loading="lazy" alt="dog Food"
                    class="img-cover">
                </figure>

                <h3 class="h3">
                  <div class="fs-5 mb-4">
                    <span class="fs-1 fw-bold">Rp570.000</span><br>
                    <p class="fs-6 fw-light mb-1">Stok tersedia: 10</p>
                  </div>
                  <a href="#" class="btn">Shop Now</a>
                </h3>
            ...
            <td>
              <tr>Komposisi: protein unggas terdehidrasi, lemak hewani, beras, isolat protein nabati*, protein hewani
                terhidrolisis, bubur bit, serat nabati, minyak ikan, mineral, sekam dan biji psyllium, minyak kedelai,
                ekstrak marigold (sumber lutein), ragi terhidrolisis ( sumber manno-oligo-sakarida), krustasea
                terhidrolisis (sumber glukosamin), tulang rawan terhidrolisis (sumber kondroitin).</tr>
            </td>
            <br><br>
            <td>
            ...
            <br><br>
            <td>
              <tr>Bahan analitik: Protein: 32,0% - Kandungan lemak: 30,0% - Abu kasar: 8,3% - Serat kasar: 2,0% - Per
                kg: Lutein: 15,5 mg - Beta-karoten: 2,3 mg.</tr>
            </td><br>
